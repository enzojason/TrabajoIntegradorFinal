...
import SongArtistForm from '../Artist/SongArtistForm';

import artistIMG from '../../assets/artista.png'
                    ...
                    <div className="media">
                            ...
                            <div className="media-left">
                                <figure className="image is-30x30">
                                    <img src={artist.image|| artistIMG} style={{ maxWidth: '500px', maxHeight: '500px' }} alt="" />
                                </figure>
                            </div>
                            ...
                            <div className="media-content">
                                ...
                                <p>Fecha de Creación: {new Date(artist.created_at).toLocaleDateString()}</p>
