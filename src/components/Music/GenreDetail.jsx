...
import SongGenreForm from '../Genre/SongGenreForm';

import genreIMG from '../../assets/genero.png'

function GenreDetail({ genres }) {
              ...
              <div className=''>
                            <div className="media-left">
                                <figure className="image is-30x30">
                                    <img src={genres.image|| genreIMG} style={{ maxWidth: '500px', maxHeight: '500px' }} alt="" />
                                </figure>
                            </div>
  
                    <p className="title is-4"><strong>{genres.name}</strong></p>
                    <br />
                    <p className="subtitle is-6" style={{ overflow: 'auto', maxHeight: '100px', fontSize: '16px'  }}><span className="has-text-weight-bold">Descripción:</span> {genres.description}</p>
